...
SECRET_KEY = 'django-insecure-mzx!2b&md$=s_awm&mai=%=%g*pag7p151y9kw@z-$4f7dmr2^'
...
# Email - dev: prints to console (use real email config in prod)
EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"
DEFAULT_FROM_EMAIL = "noreply@socialconnect.local"
